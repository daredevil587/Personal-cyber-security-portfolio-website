    ...
    <div className="grid md:grid-cols-2 gap-5">
      {awards.map(award => {
        ...
        return (
          <motion.article
            key={award.title}
            className="p-5 rounded-xl border border-amber-500/20 bg-gradient-to-br from-amber-500/10 to-[#0d1423]"
          >
            ...
            <h4 className="font-bold text-[#e6edf3] mb-1">{award.title}</h4>
